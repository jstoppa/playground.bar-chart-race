...
{
    public static class PlaidGetIdentity
    {
        [FunctionName("PlaidGetIdentity")]
        public static async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "post", Route = "plaid/identity/get")] HttpRequest req,
            ILogger log,
            ExecutionContext context)
        {
            ...
            var httpRequestMessage = new HttpRequestMessage(HttpMethod.Post,
                $"https://{apiConfig.EnvUrl}/identity/get");
